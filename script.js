...
//     //convert it from JSON to javascript object
...
// getCountryAndNeigbour('United states of america');
...
// requests.open('GET', `https://api.openbrewerydb.org/breweries/new_york`);
// requests.send();
...
//using fetch -- promise
const requests = fetch('https://api.openbrewerydb.org/breweries/')
  .then(response => {
    return response.json();
  })
  .then(data => {
